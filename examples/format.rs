...
type FormattingFunction = &'static dyn Fn(sonja_hecs::EntityRef<'_>) -> Option<String>;

fn format_entity(entity: sonja_hecs::EntityRef<'_>) -> String {
    fn fmt<T: sonja_hecs::Component + std::fmt::Display>(entity: sonja_hecs::EntityRef<'_>) -> Option<String> {
...
fn main() {
    let mut world = sonja_hecs::World::new();
